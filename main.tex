...
M87*'s mass accretion rate upper limit is obtained from a RM assuming a model for the density and magnetic field strength and geometry in the RIAF in which it is roughly spherical with $\rho(r) \propto r^{-\beta}$ and the magnetic field is well ordered, radial and of equipartition strength (cf. \citealt{Marrone2006,Kuo2014}). These assumptions seem to be broadly reasonable according to GRMHD simulations \eg{Porth2019}. 
