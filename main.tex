...
\begin{figure*}
    ...
    \end{minipage}
\caption{Allowed parameter space for M87*--spin, magnetic flux and $\beta$--which is consistent with the average observed jet power. The left and right panels display the prograde and retrograde cases, respectively. The MAD and SANE states correspond to the top and bottom part of the plots, respectively. The hatched region indicates parameters which are forbidden to the SMBH because they would imply  $|a_*|>0.998$. }
\label{spins-phi}
\end{figure*}
...
including all SANE models considered by the EHTC 
